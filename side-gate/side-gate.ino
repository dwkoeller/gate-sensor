...
#define MQTT_DEVICE "side-gate" // Enter your MQTT device
...
void setup() {
  ...
  pinMode(SIDE_GATE_PIN, INPUT_PULLUP); 
...
void checkDoorState() {
  ...
  if (digitalRead(SIDE_GATE_PIN) == 0) {
